...
namespace Planet
{
    ...
    class CycloneGun : Weapon
    {
        ...
        protected override void Shoot()
        {
            ...
            Projectile center = new Projectile(null, ship.Pos, ship.GetDirection(), projSpeed, 0, null, projLifeTime, null);
            center.Scale = 1.0f;
            ...
            if (p.destroyed)
            {
                for (int i = -1; i <= 1; i += 2)
                {
                    ...
                    Projectile p2 = new Projectile(
                        ...
                        3,
                        null);
                    Game1.objMgr.PostProjectile(p2);
                }
            }
